...
function get_exp_stats(subj::subj_t)
	...
	m_rt_2_corr = mean(subj.rt_v[map((x,y) -> x == 2 && y == 2, subj.tone_v, subj.response_v)]) ;
	m_rt_2_incorr = mean(subj.rt_v[map((x,y) -> x == 2 && y == 8, subj.tone_v, subj.response_v)]) ;

	m_rt_8_corr = mean(subj.rt_v[map((x,y) -> x == 8 && y == 8, subj.tone_v, subj.response_v)]) ;
	m_rt_8_incorr = mean(subj.rt_v[map((x,y) -> x == 8 && y == 2, subj.tone_v, subj.response_v)]) ;

	std_rt_2_corr = std(subj.rt_v[map((x,y) -> x == 2 && y == 2, subj.tone_v, subj.response_v)]) ;
	std_rt_2_incorr = std(subj.rt_v[map((x,y) -> x == 2 && y == 8, subj.tone_v, subj.response_v)]) ;

	std_rt_8_corr = std(subj.rt_v[map((x,y) -> x == 8 && y == 8, subj.tone_v, subj.response_v)]) ;
	std_rt_8_incorr = std(subj.rt_v[map((x,y) -> x == 8 && y == 2, subj.tone_v, subj.response_v)]) ;

	n_2_corr = length(subj.response_v[map((x,y) -> x == 2 && y == 2, subj.tone_v, subj.response_v)]) ;	
	n_2_incorr = length(subj.response_v[map((x,y) -> x == 2 && y == 8, subj.tone_v, subj.response_v)]) ;

	n_8_corr = length(subj.response_v[map((x,y) -> x == 8 && y == 8, subj.tone_v, subj.response_v)]) ;
	n_8_incorr = length(subj.response_v[map((x,y) -> x == 8 && y == 2, subj.tone_v, subj.response_v)]) ;
